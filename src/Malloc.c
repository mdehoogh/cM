...
static char const * const MODULE_NAMES[]={"Moutput","Mmessage","Malloc","Mchars","Mstring","Msettings","Mtoken","Mmemory","Mexecution","Mbiginteger","Mrational","Mdecimal","Mvalue","Mtime","Miterator","Marray","Mlist","Mlocale","Mfunctions","Menvironment","Mshell","Mcolors","Msession","M"};
