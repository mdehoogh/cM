...
/**
 * @brief a sequence element contains an iterator index and a M value
 * 
 */
...
/**
 * @brief contains the iterator source in valueholder, the next method and next index method, the lastindex indicating the last possible index, and the current state of the iterator in index
 * 
 */
