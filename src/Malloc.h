...
void obtainAllocationStats(unsigned long long occupations[257],unsigned long long valuetypecounts[256],unsigned long long *offered,unsigned long long *refused,unsigned long long* consumed);
