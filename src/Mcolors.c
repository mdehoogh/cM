...
const char* UNARY_OPERATOR_COLORS[NUMBER_OF_COLOR_SCHEMES]={LIGHT_GREEN,DARK_GREEN};
...
const char* PLACEHOLDER_COLORS[NUMBER_OF_COLOR_SCHEMES]={WHITE,BLACK}; // MDH@26MAR2024: something indeterminate
...
const char* FEEDFORWARD_CLOSER_TEXT_COLORS[NUMBER_OF_COLOR_SCHEMES]={DARK_PURPLE,LIGHT_PURPLE}; // MDH@04DEC2023
const char* UNREACHABLE_FINISHER_TEXT_COLORS[NUMBER_OF_COLOR_SCHEMES]={DARK_YELLOW,LIGHT_YELLOW}; // MDH@10DEC2024
...
// value token colors
const char** VALUE_TOKEN_COLORS[]={EXPRESSION_COLORS,REFERENCE_COLORS,VARIABLE_COLORS,NEW_VARIABLE_COLORS,VARIABLE_COLORS,LIST_COLORS,NUMBER_COLORS,NUMBER_COLORS,STRING_COLORS,STRING_COLORS,STRING_COLORS,STRING_COLORS,LIST_COLORS,LIST_COLORS,MAP_COLORS,MAP_COLORS,MAP_COLORS,FUNCTION_COLORS,FUNCTION_COLORS,FUNCTION_COLORS,PLACEHOLDER_COLORS};
...
const char* getUnreachableFinisherStackTextColor(){return UNREACHABLE_FINISHER_TEXT_COLORS[colorscheme];} // MDH@10DEC2024
