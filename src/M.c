...
Mstring* _shellCommand=NULL;Mallocationowner owner_shellCommand=(Mallocationowner){MODULE_ID,__LINE__};

Mcommand* _userInputCommand=NULL;Mallocationowner owner_userInputCommand=(Mallocationowner){MODULE_ID,__LINE__}; // the current input command
...
Muserinputline* _userinputline=NULL;Mallocationowner owner_userinputline=(Mallocationowner){MODULE_ID,__LINE__};
...
Mstring* _manualFeedforwardText=NULL;Mallocationowner owner_manualFeedforwardText=(Mallocationowner){MODULE_ID,__LINE__};
...
Mtokenautocompletiontext *_firstTokenautocompletiontext=NULL,*_lastConsumedAutocompletiontext=NULL;Mallocationowner tokenautocompletiontextowner=(Mallocationowner){MODULE_ID,__LINE__};
...
Mallocationowner owner_autoCompletionText=(Mallocationowner){MODULE_ID,__LINE__};
...
Mallocationowner owner_tokenAutoCompletionTexts=(Mallocationowner){MODULE_ID,__LINE__};
...
Mstring* _immediateFeedforwardText=NULL;Mallocationowner owner_immediateFeedforwardText=(Mallocationowner){MODULE_ID,__LINE__};
...
*/
Mstring* _suggestedText=NULL;Mallocationowner owner_suggestedText=(Mallocationowner){MODULE_ID,__LINE__}; // MDH@04SEP2019: where we'll be storing the entire feed forward text (i.e. identifier continuation, immediate feed forward and auto completion text)
...
Mallocationowner owner_commands=(Mallocationowner){MODULE_ID,__LINE__};
Mallocationowner owner_currentFunctionBodyInput=(Mallocationowner){MODULE_ID,__LINE__};
...
Mvalue* M_value=NULL;Mallocationowner owner_M_value=(Mallocationowner){MODULE_ID,__LINE__}; // where the list of evaluated commands is to be stored 
		...
		if(fp){
			...
			path[0]='\''; // a single-quote to surround the output text lines
  			...
  			while(fgets(path+1,sizeof(path)-1,fp)!=NULL){
				  ...
				  Mvalue* _pathValue=(Mvalue*)OWNED(_getTextValue(path),owner);
...
static Mstring* _separator=NULL;Mallocationowner owner_separator=(Mallocationowner){MODULE_ID,__LINE__};
