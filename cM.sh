...
echo "Compiling M..."
/usr/bin/cc  -L . -ltommath -lmpdec mstring.c Msettings.c Mcolors.c Moutput.c Msession.c Mexpression.c Mmemory.c Mexecution.c M.c -o M -Wincompatible-pointer-types
